...
[[maybe_unused]] static nx::video::VideoRequest translate_to_video_engine_request(const VideoAnalyzeRequest& /* cli_request */) {
    return nx::video::VideoRequest{};
}

[[maybe_unused]] static nx::video::VideoRequest translate_to_video_engine_request(const VideoProcessRequest& /* cli_request */) {
    return nx::video::VideoRequest{};
}

[[maybe_unused]] static nx::video::VideoRequest translate_to_video_engine_request(const VideoVerifyRequest& /* cli_request */) {
    return nx::video::VideoRequest{};
}
